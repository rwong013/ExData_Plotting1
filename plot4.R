...
png(file = 'C:/Users/rwong/Documents/DSS/ExploratoryDataAnalysis/Proj1/ExData_Plotting1/plot4.png')
...
with(powerconsSub, {
  ...
  #4th plot (y label is left as default Global_reactive_power)
